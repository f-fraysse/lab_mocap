"""
Specialized angle graph widget for treadmill GUI
Fixed Y-axis limits and larger title fonts
"""
...
class TreadmillAngleGraph(QWidget):
    """Widget for displaying joint angle time history with fixed Y-axis"""
    
    def __init__(self, title, y_min, y_max, parent=None):
        ...
        # Configure plot with larger title
